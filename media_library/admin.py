...
class MediaFileAdmin(admin.ModelAdmin):
    list_display = ('title', 'file_type', 'file_preview', 'uploaded_at')
    list_filter = ('file_type', 'categories', 'uploaded_at')
    search_fields = ('title', 'description', 'alt_text')
    readonly_fields = ('file_preview', 'file_type', 'width', 'height', 'uploaded_at', 'updated_at')
    fieldsets = (
        (None, {
            'fields': ('title', 'file', 'alt_text', 'description', 'categories')
        }),
        ('File Information', {
            'fields': ('file_preview', 'file_type', 'width', 'height', 'uploaded_at', 'updated_at'),
            'classes': ('collapse',),
        }),
    )
